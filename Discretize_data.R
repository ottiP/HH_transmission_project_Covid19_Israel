...
#Step 1a, count all people who have not yet been infected, regardless of household infection status, by vaccine status and age group at that time

#Step 1b: instead do this but count by age group and vaccine status at that date
